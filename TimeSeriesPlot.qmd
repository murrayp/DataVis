...
app_ui = ui.page_fluid(
    ...
    ui.input_checkbox(id='detrend',label="detrend",value=['detrend']),
    ui.input_checkbox(id='donorm',label="Normalise",value=['donorm']),
    ui.input_checkbox(id='difference',label="Difference",value=['donorm']),
...
Time (mins),Untreated,DMSO,Monastrol,Washout,pcna_Untreated,pcna_DMSO,pcna_Monastrol,pcna_Washout
